...
CREATE TABLE `adm` (
  ...
  `descricao` text,
  `setor` varchar(20) DEFAULT 'geral',
...
CREATE TABLE `aluno` (
  ...
  CONSTRAINT `fk_usu_aluno` FOREIGN KEY (`fk_usu_aluno`) REFERENCES `usuario` (`id`)
...
INSERT INTO `aluno` VALUES (1,'ativo','MAT2023001','Perder peso e ganhar resistência',1);
...
INSERT INTO `personal` VALUES (2,3500.00,200.00,'Musculação',2);
...
-- Dump completed on 2025-04-24 14:19:41
